        ...
        [
            dbc.Row(
                [
                    ...
                    html.Div(id="expense-table", className="dbc"),
                ]
            ),
            dbc.Row(
                [
...
# =========  Callbacks  =========== #
# Tabela
@app.callback(Output("expense-table", "children"), Input("store-expenses", "data"))
...
# Simple card
@app.callback(Output("expense_value_card", "children"), Input("store-expenses", "data"))
